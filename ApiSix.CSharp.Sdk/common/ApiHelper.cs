...
namespace ApiSix.CSharp
{
    ...
    public static class ApiHelper
    {
        ...
        /// <returns></returns>
        public static async Task<TResult> GetAsync<TResult>(this HttpClient client, String action, Object args = null, IDictionary<string, string> headers = null, CancellationToken cancellationToken = default) => await client.InvokeAsync<TResult>(HttpMethod.Get, action, args, headers, null, "data", cancellationToken);
        ...
        /// <param name="cancellationToken">取消通知</param>
        /// <returns></returns>
        public static async Task<TResult> PostAsync<TResult>(this HttpClient client, String action, Object args = null, IDictionary<string, string> headers = null, CancellationToken cancellationToken = default) => await client.InvokeAsync<TResult>(HttpMethod.Post, action, args, headers, null, "data", cancellationToken);
        ...
        /// <param name="args">参数</param>
        /// <returns></returns>
        public static TResult Post<TResult>(this HttpClient client, String action, Object args = null, IDictionary<string, string> headers = null)
            => Task.Run(() => PostAsync<TResult>(client, action, args, headers)).Result;
        ...
        /// <param name="cancellationToken">取消通知</param>
        /// <returns></returns>
        public static async Task<TResult> PutAsync<TResult>(this HttpClient client, String action, Object args = null, IDictionary<string, string> headers = null, CancellationToken cancellationToken = default)
            => await client.InvokeAsync<TResult>(HttpMethod.Put, action, args, headers, null, "data", cancellationToken);
        ...
        ///// <param name="cancellationToken">取消通知</param>
        ///// <returns></returns>
        //public static async Task<TResult> PatchAsync<TResult>(this HttpClient client, String action, Object args = null, IDictionary<string, string> headers = null, CancellationToken cancellationToken = default)
        //    => await client.InvokeAsync<TResult>(HttpMethod.Patch, action, args, headers, null, "data", cancellationToken);
        ...
        /// <param name="cancellationToken">取消通知</param>
        /// <returns></returns>
        public static async Task<TResult> DeleteAsync<TResult>(this HttpClient client, String action, Object args = null, IDictionary<string, string> headers = null, CancellationToken cancellationToken = default) => await client.InvokeAsync<TResult>(HttpMethod.Delete, action, args, headers, null, "data", cancellationToken);
        ...
        /// <param name="cancellationToken">取消通知</param>
        /// <returns></returns>
        public static async Task<TResult> InvokeAsync<TResult>(this HttpClient client, HttpMethod method, String action, Object args = null, IDictionary<string, string> headers = null, Action<HttpRequestMessage> onRequest = null, String dataName = "data", CancellationToken cancellationToken = default)
        {
            ...
            // 构建请求
            var request = BuildRequest(method, action, args, headers);
        ...
        /// <param name="args">参数</param>
        /// <returns></returns>
        public static HttpRequestMessage BuildRequest(HttpMethod method, String action, Object args, IDictionary<string, string> headers = null)
        {
            // 序列化参数，决定GET/POST
        ...
        static void BuildHeader(HttpRequestMessage request, IDictionary<string, string> headers)
        {
            if (request == null) return;
            var dem = headers.GetEnumerator();
            while (dem.MoveNext())
            {
        ...
        {
            //var gzip = Setting.Current.AutoGZip;
        ...
        public static async Task<TResult> ProcessResponse<TResult>(HttpResponseMessage response, String codeName, String dataName)
        {
            ...
            // 异常处理
            if (response.StatusCode >= HttpStatusCode.BadRequest) throw new ApisixSDKExcetion( buf.ToStr()?.Trim('\"') ?? response.ReasonPhrase, response.StatusCode.GetHashCode());
        ...
        public static TResult ProcessResponse<TResult>(String response, String codeName, String dataName)
        {
            ...
            var dic = response.StartsWith("<") && response.EndsWith(">") ? response.DecodeXml() : response.DecodeJson();
            ...
            if (code != 0 && code >= 400) //code != 200
            {
                ...
                throw new ApisixSDKExcetion(message, code);
            }
            ...
            if (!(data is IDictionary<String, Object>) && !(data is IList<Object>))
                throw new InvalidDataException("未识别响应数据");

            return data.ConvertObject<TResult>();
        }
